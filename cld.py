...
f.addConstraint('ZhllWWhad','(1+Z)*(1+Z)*((1+W)*(1+W) + (1+g)*(1+g))/width','Z,W,g,width',1,0.0150*f350)
f.addConstraint('ZhllWW1lep','(1+Z)*(1+Z)*(1+W)*(1+W)/width','Z,W,width',1,0.0182*f350)
f.addConstraint('ZhqqWW2lep','(1+Z)*(1+Z)*((1+W)*(1+W) + (1+tau)*(1+tau))/width','Z,W,tau,width',1,0.0350*f350)
f.addConstraint('ZhqqWW2lep','(1+Z)*(1+Z)*(1+W)*(1+W)/width + (1+Z)*(1+Z)*(1+g)*(1+g)/width','Z,W,g,width',1,0.0637*f350)
